...
\begin{minipage}[t]{.45\textwidth}
  ...
  \captionof{figure}[Loss function plotted for values of the target probability]{The loss function plotted for three different values of the target probability \cite{Burges:learningtorankwithsgd}}
  \label{fig:costfn}
\end{minipage}\hfill%
%
\begin{minipage}[t]{.45\textwidth}
