...
Main paper is \cite{liu2009learningtorank}\\
Ways of ranking, high level: pointwise (scalar, bins w and w/o specifics), pairwise, listwise.

Ranking metric optimization; specifics of training with SGD, batches, ... Also cited very often, learning to rank with SGD: \cite{Burges:learningtorankwithsgd}
