...
The list can be downloaded from \url{https://www.domcop.com/openpagerank/}.
...
\texttt{CEF} is available at \url{https://bitbucket.org/chromiumembedded}.
...
K8s is available at \url{https://kubernetes.io}.
