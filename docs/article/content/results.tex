...
\begin{table}
    ...
    \begin{tabular}{lrrrr}
        ...
        \textbf{[woft]} & $xx\%$ $xx\%$ & $0$ & 0 \\
        \textbf{[baseline+avg]} & $xx\%$ & $+xx\%$ & $65$ & 1\\
        \textbf{[baseline+max]} & $xx\%$ & $+xx\%$ & $65$ & 1\\
        \textbf{[1-core]} & $xx\%$ & $+xx\%$ & $41,217$ & 3\\
        \textbf{[3-core]} & $xx\%$ & $+xx\%$ & $123,521$ & 5\\
        \textbf{[3-core-shared]} & $xx\%$ & $+xx\%$ & $41,217$ & 5\\
    \end{tabular}
