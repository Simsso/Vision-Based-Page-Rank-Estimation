...
\begin{table}
    ...
    \end{tabular}
    \caption[Activation maps of the screenshot feature extractor]{Activation maps of the screenshot feature extractor + to be updated; depth indicates the number of non-linearities the data went through.}
